...
DATABASES = {
    'default': {
        ...
        'HOST': 'awsproject-rds.ca38c0cm2xfc.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awsproject-berfin-blog' # please enter your s3 bucket name
